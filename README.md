...
[릴리스에서 최종 버전](https://github.com/hatemogi/github-ko-ext/releases/tag/0.1.4)을 받아 적당한 위치에 압축을 푼 다음, 크롬 확장 프로그램 <chrome://extensions>에서 "개발자 모드"를 켜신(ON)다음, "압축 해제된 확장 프로그램 로드"를 눌러 조금 전 압축을 풀어 놓은 디렉터리를 지정하시면, "GitHub 한글화" 확장 프로그램이 설치되며, 이 이후 깃헙에 방문하시면 주요 페이지들이 한글로 보이는 것을 확인하실 수 있습니다.
