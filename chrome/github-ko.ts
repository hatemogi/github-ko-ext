...
const 번역목록: 번역정보[] = [
    ...
    번역("1100E", ".col-md-9.col-12 h2", [[/Public profile/, "공개 프로필"]]),
    ...
    번역("1100H", ".col-md-9.col-12 h2", [[/Change username/, "계정명 변경"]]),
    번역("1100I", ".col-md-9.col-12 summary", [[/Change username/, "계정명 변경"]]),
    번역("1100J", ".col-md-9.col-12 p", [[/Looking to manage account security settings/, "계정 보안 설정을 관리하는 법을 찾고 계신가요?"]]),
    번역("1100K", ".col-md-9.col-12 h2", [[/Export account data/, "계정 데이터 내보내기"]]),
    번역("1100L", ".col-md-9.col-12 p", [[/Export all repositories and profile metadata for/, "다음 계정에 대한 모든 저장소와 메타데이터를 내보냅니다 : "], [/Exports will be available for 7 days/, "내보내기는 7일간 유효합니다"]]),
    번역("1100L", ".col-md-9.col-12", [[/Start export/, "내보내기 시작"]]),
    번역("1100M", ".col-md-9.col-12 h2", [[/Successor settings/, "후속 설정"]]),
    번역("1100N", ".col-md-9.col-12 label", [[/Search by username, full name, or address/, "유저명 혹은 전체 이름, 이메일 주소로 찾기"]]),
